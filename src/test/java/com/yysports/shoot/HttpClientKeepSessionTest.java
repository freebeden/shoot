...
public class HttpClientKeepSessionTest {
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(HttpClientKeepSessionTest.class);
    ...
    public static CloseableHttpResponse get(String url) throws ClientProtocolException, IOException {
        ...
        try {
            ...
            LOGGER.info("authCache=" + authCache);
            HttpRequest request = context.getRequest();
            Header uid = request.getFirstHeader("uid");
            LOGGER.info("uid=" + uid);
            Object userToken = context.getUserToken();
            LOGGER.info("userToken=" + userToken);
            Object uid1 = context.getAttribute("uid");
            LOGGER.info("uid1=" + uid1);
            HttpResponse response1 = context.getResponse();
    ...
    public void doLogin() throws Exception{
        ...
        String param = "username=hemin1997&password=123456&client_id=matrix&response_type=code&state=d7d396c410574f52b9b993cca3f4ce74&redirect_uri=http://wx.yysports.com/limitelottery/form.html";
        //用户登陆
        CloseableHttpResponse response = HttpClientKeepSessionTest.post(url, param);
        ...
        //上传数据
        /*HttpClientKeepSessionTest.upload("http://localhost:8080/BCP/all/test/upload");
        printCookies();*/
    }
    ...
    public void doget() throws Exception{
        ...
        HttpClientKeepSessionTest.get(url);
    }
