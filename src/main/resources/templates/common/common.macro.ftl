...
<#-- common -->
    ...
    <script src="${request.contextPath}/static/plugins/js/bootstrap-datetimepicker.min.js"></script>
    <script src="${request.contextPath}/static/plugins/js/bootstrap-datetimepicker.zh-CN.js"></script>
</#macro>
