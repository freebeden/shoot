...
public class HttpClientKeepSession {
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(HttpClientKeepSession.class);
    ...
    public static String doPost(String url, String json,String jwt) {
        ...
        try {
            ...
            if(statuscode==200){
                cookieStore = ((AbstractHttpClient) response).getCookieStore();
